...
if(!$(refSelector).length){var refSelector='#submitdiv div.misc-pub-curtime';}
...
var RvyUIInterval=setInterval(RvySubmissionUI,100);$('a.save-timestamp').click(function(){$('#save-post').val(rvyObjEdit.updateCaption);});$(document).on('click','a.save-timestamp, a.cancel-timestamp',function(){wp.autosave.server.triggerSave();});function RvyGetRandomInt(max){return Math.floor(Math.random()*max);}
