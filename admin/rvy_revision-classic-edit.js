jQuery(document).ready(function($){var RvySubmissionUI=function(){var refSelector='.rvy-misc-actions';if(!$(refSelector).length){var refSelector='#submitdiv div.misc-pub-section:last';}
